...
/**
 * The <tt>TrieST</tt> class represents an symbol table of key-value pairs, with string keys and generic values. It supports the usual
 ...
 * <p>
 * This implementation uses a 256-way trie. The <em>put</em>, <em>contains</em>, <em>delete</em>, and <em>longest prefix</em> operations
 * take time proportional to the length of the key (in the worst case). Construction takes constant time. The <em>size</em>, and
...
public class TrieST<Value> {
	...
	private static final int R = 256; // root of trie
