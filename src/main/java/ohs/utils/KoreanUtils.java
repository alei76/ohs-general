...
public class KoreanUtils {
	/*
	 * ********************************************** 자음 모음 분리 설연수 -> ㅅㅓㄹㅇㅕㄴㅅㅜ,
	 * 바보 -> ㅂㅏㅂㅗ
	 **********************************************/
	/** 초성 - 가(ㄱ), 날(ㄴ) 닭(ㄷ) */
	public static final char[] CHO_SUNG = { 0x3131, 0x3132, 0x3134, 0x3137, 0x3138, 0x3139, 0x3141, 0x3142, 0x3143,
			0x3145, 0x3146, 0x3147, 0x3148, 0x3149, 0x314a, 0x314b, 0x314c, 0x314d, 0x314e };
	/** 중성 - 가(ㅏ), 야(ㅑ), 뺨(ㅑ) */
	public static final char[] JUNG_SUNG = { 0x314f, 0x3150, 0x3151, 0x3152, 0x3153, 0x3154, 0x3155, 0x3156, 0x3157,
			0x3158, 0x3159, 0x315a, 0x315b, 0x315c, 0x315d, 0x315e, 0x315f, 0x3160, 0x3161, 0x3162, 0x3163 };
	/** 종성 - 가(없음), 갈(ㄹ) 천(ㄴ) */
	public static final char[] JONG_SUNG = { 0x0000, 0x3131, 0x3132, 0x3133, 0x3134, 0x3135, 0x3136, 0x3137, 0x3139,
	...
	/*
	 * ********************************************** 알파벳으로 변환 설연수 -> tjfdustn,
	 * 멍충 -> ajdcnd
	 **********************************************/
	/** 초성 - 가(ㄱ), 날(ㄴ) 닭(ㄷ) */
	public static final String[] CHO_SUNG_ENG = { "r", "R", "s", "e", "E", "f", "a", "q", "Q", "t", "T", "d", "w", "W",
			"c", "z", "x", "v", "g" };

	/** 중성 - 가(ㅏ), 야(ㅑ), 뺨(ㅑ) */
	public static final String[] JUNG_SUNG_ENG = { "k", "o", "i", "O", "j", "p", "u", "P", "h", "hk", "ho", "hl", "y",
			"n", "nj", "np", "nl", "b", "m", "ml", "l" };

	/** 종성 - 가(없음), 갈(ㄹ) 천(ㄴ) */
	public static final String[] JONG_SUNG_ENG = { "", "r", "R", "rt", "s", "sw", "sg", "e", "f", "fr", "fa", "fq",
			"ft", "fx", "fv", "fg", "a", "q", "qt", "t", "T", "d", "w", "c", "z", "x", "v", "g" };

	/** 단일 자음 - ㄱ,ㄴ,ㄷ,ㄹ... (ㄸ,ㅃ,ㅉ은 단일자음(초성)으로 쓰이지만 단일자음으론 안쓰임) */
	public static final String[] SINGLE_JAUM_ENG = { "r", "R", "rt", "s", "sw", "sg", "e", "E", "f", "fr", "fa", "fq",
			"ft", "fx", "fv", "fg", "a", "q", "Q", "qt", "t", "T", "d", "w", "W", "c", "z", "x", "v", "g" };

	public static char[] changeKoreanCharToEnglish(char c) {
	...
	public static char[][] changeKoreanWordToEnglish(String word) {
		char[][] ret = new char[word.length()][];
		for (int i = 0; i < word.length(); i++) {
			ret[i] = changeKoreanCharToEnglish(word.charAt(i));
		}
		return ret;
	}
	...
	public static String getDecomposedString(String word) {
	...
	public static void main(String args[]) {
		...
		System.out.println("알파벳   : " + getString(changeKoreanWordToEnglish(word)));
	}
}