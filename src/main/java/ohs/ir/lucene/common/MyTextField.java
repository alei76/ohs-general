...
public final class MyTextField extends Field {
	...
	/**
	 * Creates a new un-stored CDSTextField with Reader value.
	 * 
	 * @param name
	 *            field name
	 * @param reader
	...
	/**
	 * Creates a new CDSTextField with String value.
	 * 
	 * @param name
	 *            field name
	 * @param value
	...
	/**
	 * Creates a new un-stored CDSTextField with TokenStream value.
	 * 
	 * @param name
	 *            field name
	 * @param stream
